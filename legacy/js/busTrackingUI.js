...
class BusTrackingUI {
            ...
            <div class="bg-white dark:bg-gray-900 rounded-lg w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
                <div class="p-4 sm:p-6">
                    <div class="flex items-start mb-4">
                        ...
                        <h2 class="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-100 leading-tight">${t('trackingDisclaimer')}</h2>
                    </div>
                    ...
                    <div class="space-y-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <div class="mt-6 flex items-center hidden">
                        ...
                        <label for="dontShowAgainCheckbox" class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                            ${t('dontShowAgain')}
                        </label>
                    </div>
                </div>
                
                <div class="px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 dark:bg-gray-800 border-t dark:border-gray-700 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3">
                    <button onclick="BusTrackingUI.cancelTracking()" class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 text-sm sm:text-base order-2 sm:order-1" data-umami-event="cancel-tracking">
                        ${t('cancel')}
                    </button>
    ...
    static createPinRouteModal(routeData) {
        ...
        modal.innerHTML = `
            <div class="bg-white dark:bg-gray-900 rounded-lg w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
                <div class="p-4 sm:p-6">
                    <div class="flex items-start mb-4">
                        <i class="fas fa-thumbtack text-green-500 text-xl sm:text-2xl mr-3 mt-0.5"></i>
                        <h2 class="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-100 leading-tight">${t('pinRouteTitle')}</h2>
                    </div>
                    
                    <div class="mb-4">
                        <h3 class="font-medium text-gray-700 dark:text-gray-300 mb-2 text-sm sm:text-base">${t('routeDetails', 'Route Details')}</h3>
                        <div class="bg-gray-50 dark:bg-gray-800 p-3 rounded-lg">
                            <div class="flex items-center mb-2">
                                <i class="fas fa-bus text-gray-500 dark:text-gray-400 mr-2"></i>
                                <span class="font-medium text-sm sm:text-base">${routeData.routeNumber}</span>
                            </div>
                            <div class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 leading-relaxed mb-2">
                ...
                <div class="px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 dark:bg-gray-800 border-t dark:border-gray-700 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3">
                    <button onclick="BusTrackingUI.cancelPinning()" class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 text-sm sm:text-base order-2 sm:order-1" data-umami-event="cancel-pin-route">
                        ${t('cancel')}
                    </button>
        ...
        modal.innerHTML = `
            <div class="bg-white dark:bg-gray-900 rounded-lg w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
                <div class="p-4 sm:p-6">
                    <div class="flex items-start mb-4">
                        <i class="fas fa-exclamation-triangle text-yellow-500 text-xl sm:text-2xl mr-3 mt-0.5"></i>
                        <h2 class="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-100 leading-tight">${t('journeyTrackingDisclaimer', 'Journey Tracking Disclaimer')}</h2>
                    </div>
                ...
                <div class="px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 dark:bg-gray-800 border-t dark:border-gray-700 flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-3">
                    <button onclick="BusTrackingUI.cancelJourneyTracking()" class="px-4 py-2 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 text-sm sm:text-base order-2 sm:order-1" data-umami-event="cancel-journey-tracking">
                        ${t('cancel')}
                    </button>
    ...
    static createPinnedRouteManagerModal() {
        ...
        modal.innerHTML = `
            <div class="bg-white dark:bg-gray-900 rounded-lg w-full max-w-md mx-4 max-h-[90vh] overflow-hidden">
                <div class="flex items-center justify-between p-3 sm:p-4 border-b">
                    <h2 class="text-lg sm:text-xl font-semibold" data-i18n="managePinnedRoutes">Manage Pinned Routes</h2>
                                            <button onclick="BusTrackingUI.closePinnedRouteManager()" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 p-1" data-umami-event="close-pinned-route-manager">
                ...
                <div class="p-3 sm:p-4 max-h-80 overflow-y-auto">
                    <div id="pinnedRouteManagerContent">
                        ${data.pinnedRoutes.length === 0 ? 
                            '<p class="text-gray-500 dark:text-gray-400 text-center py-4 text-sm sm:text-base" data-i18n="noPinnedRoutes">No pinned routes yet</p>' :
                            data.pinnedRoutes.map(route => this.createPinnedRouteManagerItem(route)).join('')
                        }
                    </div>
                </div>
                
                <div class="p-3 sm:p-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
                    <div class="flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm text-gray-600 dark:text-gray-400 space-y-2 sm:space-y-0">
                        <span>
    ...
    static createPinnedRouteManagerItem(route) {
        return `
            <div class="border border-gray-200 rounded-lg p-3 mb-3">
                ...
                <div class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-2 leading-relaxed">
