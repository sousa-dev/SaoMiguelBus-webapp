...
export function AppInstallBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(3.25rem+env(safe-area-inset-bottom))] z-[1200] border-t border-border bg-surface px-4 pb-3 pt-3 shadow-[0_-8px_24px_rgba(0,0,0,0.12)] lg:hidden">
